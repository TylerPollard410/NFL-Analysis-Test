...
save(fit_Team, file = "~/Desktop/NFL Analysis Data/fit_Team_poisson3_1.RData")
...
posteriorFit_total <- posteriorFit_home + posteriorFit_away
...
set.seed(52)
posteriorPred_total <- posteriorPred_home + posteriorPred_away
