...
pp_check(fit_result, resp = "total", ndraws = 100, type = "bars")
pp_check(fit_result, resp = "result", ndraws = 100, type = "dens_overlay")
pp_check(fit_result, resp = "total", ndraws = 100, type = "dens_overlay")
...
fitRT <- 3
assign(paste0("fit_Team", fitRT), fit_result)
assign(paste0("fixedEff_result", fitRT), fixedEff_result)
assign(paste0("randEff_result", fitRT), randEff_result)
