...
formulaFitTotal <- 
  bf(total ~ 0 + Intercept +
       ...
       #home_off_epa_cum + away_off_epa_cum + 
       #home_off_epa_cum:away_off_epa_cum +
       ...
       #home_off_epa_roll + away_off_epa_roll + 
       #home_off_epa_roll:away_off_epa_roll +
       ...
       #away_off_epa_cum + away_off_epa_cum + 
       #away_off_epa_cum:away_off_epa_cum +
       ...
       away_off_epa_roll + away_off_epa_roll + 
       #away_off_epa_roll:away_off_epa_roll +
...
## Fit ----
priorPoints <- c(
  #set_prior(horseshoe(df = 1), class = "b")
