...
gameTrainResult <- gameDataTrain$result
gameTestResult <- gameDataTest$result
...
##### Probabilities ----
gameTrainSpread <- gameDataTrain$spread_line
...
###### Fit ----
gameTestSpread <- gameDataTest$spread_line
