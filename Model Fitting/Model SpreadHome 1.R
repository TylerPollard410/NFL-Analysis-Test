...
ppd_stat_freqpoly_grouped(totalNewPreds, group = newDataPre$game_id) +
  vline_at(newDataPre$total_line)

ppc_error_hist_grouped(y = newDataPre$total_line, 
                       yrep = totalNewPreds[sample(1:sims, 1000, replace = FALSE), ], 
                       group = newDataPre$game_id)


ppd_bars(totalNewPreds)
ppd_dens_overlay(totalNewPreds)
