                    ...
                    tabItem(
                      ...
                      fluidPage(
                        ...
                        radioGroupButtons(
                          ...
                          label = "Select Player Statistic Type",
                        ...
                        ### Stat Category ---- 
                        #### Offense ----
                        conditionalPanel(condition = "input.summaryPlayerType == 'offense'",
                                         radioGroupButtons(
                        ...
                        #### Defense ----
                        conditionalPanel(condition = "input.summaryPlayerType == 'kicking'",
                                         radioGroupButtons(
                                           inputId = "summaryPlayerCategory",
                                           label = "Select Offensive Play Type",
                                           choices = c("Passing" = "passing", 
